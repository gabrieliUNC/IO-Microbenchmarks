...
./build/Write_random > benchmark_results/$1/write_random.txt
printf "\n======Done with Write Random Benchmark Test======\n\n"
printf "\n"


printf "\n======Performing Read Random Benchmark Test======\n"
./build/Read_random > benchmark_results/$1/read_random.txt
