...
printf '\n'
echo "Running benchmarks on ssd and putting results in ssd folder"
printf '\n'
...
echo "Read Size,IO Size,plots/ssd/read_size.png" | python3 myplot.py
...
echo "Write Size,IO Size,plots/ssd/write_size.png" | python3 myplot.py
...
# "Title,X-axis Label,Bytes Read"
echo "Read Stride 128kb,IO Stride,plots/ssd/read_stride.png" | python3 myplot.py
...
# Plot Benchmark for Read Stride
# "Title,X-axis Label,Bytes Read"
echo "Read Stride 256kb,IO Stride,plots/ssd/read_stride_1.png" | python3 myplot.py
...
# Plot Benchmark for Read Stride
# "Title,X-axis Label,Bytes Read"
echo "Read Stride 1MB,IO Stride,plots/ssd/read_stride_2.png" | python3 myplot.py
...
# Plot Benchmark for Read Stride
# "Title,X-axis Label,Bytes Read"
echo "Read Stride 2MB,IO Stride,plots/ssd/read_stride_3.png" | python3 myplot.py
...
# Plot Benchmark for Read Stride
# "Title,X-axis Label,Bytes Read"
echo "Read Stride 4MB,IO Stride,plots/ssd/read_stride_4.png" | python3 myplot.py
...
# "Title,X-axis Label,Bytes Written"
echo "Write Stride 128kb,IO Stride,plots/ssd/write_stride.png" | python3 myplot.py
...
# Plot Benchmark for Write Stride
# "Title,X-axis Label,Bytes Written"
echo "Write Stride 256kb,IO Stride,plots/ssd/write_stride_1.png" | python3 myplot.py
...
# Plot Benchmark for Write Stride
# "Title,X-axis Label,Bytes Written"
echo "Write Stride 1MB,IO Stride,plots/ssd/write_stride_2.png" | python3 myplot.py
...
# Plot Benchmark for Write Stride
# "Title,X-axis Label,Bytes Written"
echo "Write Stride 2MB,IO Stride,plots/ssd/write_stride_3.png" | python3 myplot.py
...
# Plot Benchmark for Write Stride
# "Title,X-axis Label,Bytes Written"
echo "Write Stride 4MB,IO Stride,plots/ssd/write_stride_4.png" | python3 myplot.py
...
# "Title,X-axis Label,Bytes Read"
echo "Read Random,IO Size,plots/ssd/read_random.png" | python3 myplot.py
...
# "Title,X-axis Label,Bytes Read"
echo "Write Random,IO Size,plots/ssd/write_random.png" | python3 myplot.py
