...
static void BM_4k(benchmark::State& state) {
	static const int write_amt = 1 << 12;
	// Set up buffer
...
static void BM_8k(benchmark::State& state) {
        static const int write_amt = 1 << 13;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_16k(benchmark::State& state) {
        static const int write_amt = 1 << 14;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_32k(benchmark::State& state) {
        static const int write_amt = 1 << 15;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_64k(benchmark::State& state) {
        static const int write_amt = 1 << 16;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_128k(benchmark::State& state) {
        static const int write_amt = 1 << 17;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_256k(benchmark::State& state) {
        static const int write_amt = 1 << 18;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_512k(benchmark::State& state) {
        static const int write_amt = 1 << 19;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_1M(benchmark::State& state) {
        static const int write_amt = 1 << 20;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_2M(benchmark::State& state) {
        static const int write_amt = 1 << 21;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_4M(benchmark::State& state) {
        static const int write_amt = 1 << 22;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_8M(benchmark::State& state) {
        static const int write_amt = 1 << 23;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_16M(benchmark::State& state) {
        static const int write_amt = 1 << 24;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_32M(benchmark::State& state) {
        static const int write_amt = 1 << 25;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_64M(benchmark::State& state) {
        static const int write_amt = 1 << 26;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
...
static void BM_128M(benchmark::State& state) {
        static const int write_amt = 1 << 27;
        // Set up buffer
        char* buffer = setupBuffer(write_amt);
